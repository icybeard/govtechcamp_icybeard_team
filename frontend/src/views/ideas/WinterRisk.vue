...
<template>
    <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-span-12">
            <MeasuresQueue :measures="visibleMeasures" entity-label="Район" :scores="indexValues" can-decide priority-hint="Приоритет = скор риска района (шкала 0–100, население не взвешивается); решение принимает комиссия" @set-status="setStatus" @explain="openExplain">
                <template #filter>
